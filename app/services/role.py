...
class RoleService(BaseService):
    ...
    async def update_role(self, role_id: int, version: int, data: RoleUpdate) -> int:
    ...
    async def disable_roles(self, ids: list[int]) -> int:
        return await self.dao.disable_roles(ids)

    async def bind_permissions(self, data: RoleBindIn) -> None:
